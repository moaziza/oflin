...
sudo_users = {SUDO,1390946689,1709783101,1421311181,1390949897,1844327092,1183747742}   
...
var = true
elseif tonumber(user_id) == tonumber(1390949897) then
var = true
elseif tonumber(user_id) == tonumber(1390946689) then
var = true
...
[⋆](t.me/BANDA1M) ━━━━━━[✿](t.me/BANDA1M)━━━━━━ [⋆](t.me/BANDA1M)      
  ...
  [𝚆𝙴𝙻𝙲𝙾𝙼𝙴](t.me/BANDA1M) 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 [𝙳𝙽𝙳𝚄𝚂𝙷𝙰](t.me/BANDA1M)
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mmsst13/907 &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[ها هو بوت التواصل يحبيب قلبي..🥺♥️](t.me/Rayanahmedlololbot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بوت التواصل',url="t.me/Rayanahmedlololbot"}},
} 
local msg_id = msg.id_/2097152/0.5
دندشهhttps.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mmsst13/907 &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ 𝙲𝙷 - [𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻](t.me/BANDA1M) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if tonumber(result.sender_user_id_) == tonumber(1390949897) then  
...
if result.id_ == tonumber(1390949897) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مالك السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1390949897) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مالك السورس عام")
return false 
end
