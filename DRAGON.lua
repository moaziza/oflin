...
if [ ! $token ]; then
echo "╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸ ╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE AAMMA.lua \e[0m"
echo "╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./AAMMA.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/moAAMMA/legand/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1390946689,1183747742,1844327092}   
...
os.execute('wget https://raw.githubusercontent.com/moAAMMA/legand/main/DRAGON.lua')
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/moAAMMA/legand/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/moAAMMA/legand/main/library')
os.execute('wget https://raw.githubusercontent.com/moAAMMA/legand/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
local Text = [[
━───━[source offlne](t.me/BANDA1M )━───━
⊰ welcome bro to source offlne
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/883&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/moAAMMA/legand/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/moAAMMA/legand/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس اوفلاين \n") 
end
return false
end
